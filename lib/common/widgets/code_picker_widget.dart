          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                hideHeaderText: false,  // Set this to false to show header text
            headerAlignment: MainAxisAlignment.center, // Example: Align header to the center
            headerTextStyle: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold), // Customize header text style

...
class PagesContent {
  ...
  PagesContent.fromJson(Map<String, dynamic> json) {
    aboutUs = json['about_us'] != null
        ...
        : null;
    termsAndConditions = json['terms_and_conditions_service'] != null
        ? AboutUs.fromJson(json['terms_and_conditions_service'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (termsAndConditions != null) {
      data['terms_and_conditions_service'] = termsAndConditions!.toJson();
    }
